...
//        public void Setup()
//        {
//            string path = "C:\\Users\\user1\\Desktop\\שיעורי בית\\אוטומציה\\SeleniumNUnitExample\\SeleniumNUnitExample\\chromrdriver";
...
namespace SeleniumProject
{
    ...
    public class GoogleSearchTest
    {
        ...
        public static IEnumerable<TestData> TestCases => XmlDataReader.ReadTestData("C:\\Users\\user1\\Desktop\\שיעורי בית\\אוטומציה\\SeleniumNUnitExample\\SeleniumNUnitExample\\TestData.xml");


        [OneTimeSetUp]
        public void SetUp()
        {
            string path = "C:\\Users\\user1\\Desktop\\שיעורי בית\\אוטומציה\\SeleniumNUnitExample\\SeleniumNUnitExample";

            //Creates the ChomeDriver object, Executes tests on Google Chrome

            driver = new ChromeDriver(path + @"\chromedriver\");
